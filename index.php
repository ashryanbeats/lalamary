<?php get_header(); ?>
	...
	<section class="col-md-12" id="main-content">
			<?php $index_cat = 7; ?> <!-- sets the category id number to be show on index.php -->
			<h2><?php echo get_the_category_by_ID( $index_cat ); ?></h2> <!-- archive name -->

			<!-- the archive posts -->
			<div id="product-showcase-area" class="row">			
			<?php 
				// $args sets the post type show to be 'product'; normal posts will not show. cat sets the catgory to $index_cat, the category id
				$args = array( 'post_type' => 'product', 'cat' => $index_cat, 'posts_per_page' => 16 ); //    add this to limit posts per page
